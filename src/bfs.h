...
{
	public:
		static std::tuple<int, int, int, int, int, int, int> colorbfs(enhancedgraph *g, TNGraph* graph, int color, int startNode);
		static std::tuple<int, int, int, int, int, int, int> parbfs(enhancedgraph *g, int color, int startNode);
		static std::tuple<int, int, int, int, int, int, int> relaxedSearch(enhancedgraph *g, const PNGraph& graph, int color, int startNode);
