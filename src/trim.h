...
class trim
{
  private:
	...
	static int partrim1(enhancedgraph *g, int color, bool parallel);
	static int partrim2(enhancedgraph *g, int color, bool parallel);
	static int partrim3(enhancedgraph *g, int color, bool parallel);
  public:
